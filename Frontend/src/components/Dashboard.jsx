  ...
  return (
    <div className="min-h-screen bg-black text-white p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <Link to="/advices" className="p-3 bg-teal-500 rounded-lg hover:bg-teal-600 transition">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold text-yellow-300">Total Balance</h2>
          <p className="text-3xl font-bold mt-2">$12,500</p>
        </div>

        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold text-blue-300">Monthly Income</h2>
          <p className="text-2xl font-bold mt-2">$3,200</p>
        </div>

        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold text-red-300">Monthly Expenses</h2>
      ...
      <div className="mt-10">
        <h2 className="text-2xl font-semibold text-teal-300 mb-4">Recent Transactions</h2>
      ...
      <div className="mt-10">
        <h2 className="text-2xl font-semibold text-yellow-300">Financial Insights</h2>
